...
namespace __iced_internal
{
  ...
  static_assert( offsetof ( IcedInstructionRelease, mnemonic ) == 0, "invalid offset" );
  static_assert( offsetof ( IcedInstructionRelease, mem_base ) == 2, "invalid offset" );
  static_assert( offsetof ( IcedInstructionRelease, mem_index ) == 3, "invalid offset" );
  static_assert( offsetof ( IcedInstructionRelease, mem_scale ) == 4, "invalid offset" );
  static_assert( offsetof ( IcedInstructionRelease, stack_growth ) == 5, "invalid offset" );
  static_assert( offsetof ( IcedInstructionRelease, regs ) == 6, "invalid offset" );
  static_assert( offsetof ( IcedInstructionRelease, types ) == 10, "invalid offset" );
  static_assert( offsetof ( IcedInstructionRelease, attributes ) == 14, "invalid offset" );
  static_assert( offsetof ( IcedInstructionRelease, length ) == 15, "invalid offset" );
  static_assert( offsetof ( IcedInstructionRelease, operand_count_visible ) == 16, "invalid offset" );
  static_assert( offsetof ( IcedInstructionRelease, immediate ) == 24, "invalid offset" );
  static_assert( offsetof ( IcedInstructionRelease, immediate2 ) == 32, "invalid offset" );
}
#endif