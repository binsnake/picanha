std::string GasFormatter::format_register( Register reg ) const {
...
std::string GasFormatter::format_to_string( const Instruction& instruction ) {
  std::string result;
...
void GasFormatter::format_mnemonic( const Instruction& instruction, FormatterOutput& output ) {
...
void GasFormatter::format_operands( const Instruction& instruction, FormatterOutput& output ) {
  uint32_t op_count = instruction.op_count();
...
void GasFormatter::format_operand( const Instruction& instruction, uint32_t operand,
...
void GasFormatter::format_register_operand( const Instruction& instruction, uint32_t operand,
                                                    Register reg, FormatterOutput& output ) {
  std::string name = format_register( reg );
  output.write_register( instruction, operand, name, reg );
}
void GasFormatter::format_immediate( const Instruction& instruction, uint32_t operand,
                                             FormatterOutput& output ) {
  OpKind kind = instruction.op_kind( operand );
  uint64_t value = 0;
...
void GasFormatter::format_near_branch( const Instruction& instruction, uint32_t operand,
                                               FormatterOutput& output ) {
  OpKind kind = instruction.op_kind( operand );
  uint64_t target = 0;
  int addr_size = 4;
...
void GasFormatter::format_far_branch( const Instruction& instruction, uint32_t operand,
                                              FormatterOutput& output ) {
  (void)operand;
...
void GasFormatter::format_memory( const Instruction& instruction, uint32_t operand,
                                          FormatterOutput& output ) {
  OpKind kind = instruction.op_kind( operand );
...
void GasFormatter::format_number( uint64_t value, FormatterOutput& output ) {
...
void GasFormatter::format_signed_number( int64_t value, FormatterOutput& output ) {
  if ( value < 0 ) {
    output.write( "-", FormatterTextKind::OPERATOR );
...
void GasFormatter::write_symbol( const Instruction& instruction, FormatterOutput& output,
...
void GasFormatter::format_evex_decorators( const Instruction& instruction, uint32_t operand,
                                                   FormatterOutput& output ) {
  (void)operand;
...
std::string_view GasFormatter::get_mnemonic( Mnemonic mnemonic ) const {
  bool uppercase = options_.uppercase_mnemonics() || options_.uppercase_all();
  return internal::get_mnemonic_string( mnemonic, uppercase );
}
char GasFormatter::get_size_suffix( const Instruction& instruction ) const {
